...
{
	//document.getElementById( 'div' ).innerHTML = "INSERT INTO vlc_users ( name, sname, nick, nickname, passwd, mail, platnost, etapa, aktivni, kuchar, admin, telefon ) VALUES ( '"+name+"', '"+sname+"', '"+nick+"', '"+nickname+"', '"+passwd+"', '"+mail+"', '"+platnost+"', '"+etapa+"', '"+aktivni+"', '"+kuchar+"', '"+admin+"', '"+telefon+"' );";
