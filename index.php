...
<script>
//datum tábora
var year= 2017;//2017;//2016;//2016;//2016;//2016;//2016;//2016;//2016;//2016;//2015;//2016;//a;//2017;//2016;
var mon = 07;//07;//09;//09;//09;//09;//09;//01;//01;//1;//12;//11;//f;//02;//8;
var day = 29;//29;//05;//05;//30;//05;//05;//11;//11;//11;//11;//99;//f;//22;//2;
var hod = 23;//23;//23;//23;//23;//13;//11;//11;//23;//99;//f;//13;//14;
var mnt = 59;//59;//20;//18;//11;//25;//11;//11;//59;//99;//f;//57;//0;
var sec = 0;
</script>
<title>Tábory Vlčat</title>
<?php
//echo date( 'N', strtotime( '2016-09-27' ) );
...
{
	echo "The file <strong>promenne.php</strong> does not exist.<br />";
} else {
...
<script>
    ...
    <div id="menicko">
        ...
        <form action="help/createNewUser.php">
        	<button>Create new user</button>
        </form>
        <form action="help/updateUser.php">
...
function makeCamp( where )
{
	...
	if ( parseInt(day) != day || day < 1 || day > 31 )
	{
