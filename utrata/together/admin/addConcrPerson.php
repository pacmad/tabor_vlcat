...
if ( file_exists( $promenneFile ) && require $promenneFile ) { 
	if ( ($spojeni = mysqli_connect( $db_host, $db_username, $db_password, $db_name )) && $spojeni->query("SET CHARACTER SET UTF8") ) {
		...
		$statement = "INSERT INTO utrata_members ( name, login, passwd, sendMonthly, sendByOne, mother, me, currency ) VALUES ( '".$name."', '".$login."', '".$passwd."', ".$sendMonthly.", ".$sendByOne.", '".$mother."', '".$me."', '".$currency."' )";
